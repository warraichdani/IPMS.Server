...
BEGIN
	...
	if (@firstUser = 0)
	begin
	Delete from @PortfolioUserIdTable

    insert into Users (Email,FirstName, LastName, PasswordHash, PasswordSalt, IsActive, IsDeleted, CreatedAt, EmailConfirmed)
		OUTPUT INSERTED.UserId INTO @PortfolioUserIdTable
			values('user'+ Convert(varchar, @u)+'@mail.com','Porfolio'+Convert(varchar, @u)+'', 'User'+Convert(varchar, @u)+'', 0xBC859625277E057049CA1879BC4E35F2778FA7E4F92E16D189D8503728CA9B9DE7A51CB3307FC9335ADF4C02CC2731D9E3136B5B26DCD5C3CC8CD48B253F8322
					, 
					,1, 0, '2025-12-23 12:28:19', 1)
...
close InvestmentCursor
Deallocate InvestmentCursor
